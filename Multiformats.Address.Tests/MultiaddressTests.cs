...
public class MultiaddressTests
{
    ...
    {
        Multiaddress m1 = Multiaddress.Decode("/ip4/127.0.0.1/udp/1234");
        Multiaddress m2 = Multiaddress.Decode("/ip4/127.0.0.1/tcp/1234");
        Multiaddress m3 = Multiaddress.Decode("/ip4/127.0.0.1/tcp/1234");
        Multiaddress m4 = Multiaddress.Decode("/ip4/127.0.0.1/tcp/1234");
    ...
    {
        byte[] b1 = Hex.Decode(h);
        byte[] b2 = Multiaddress.Decode(s).ToBytes();
    ...
    {
        byte[] b = Hex.Decode(h);
        string s2 = Multiaddress.Decode(s1).ToString();
    ...
    {
        Multiaddress m = Multiaddress.Decode(s);
        Multiaddress[] split = m.Split().ToArray();
        ...
        Multiaddress joined = Multiaddress.Join(split);
    ...
    {
        Multiaddress m = Multiaddress.Decode("/ip4/127.0.0.1/udp/1234");
        Multiaddress m2 = Multiaddress.Decode("/udp/5678");

        Multiaddress b = m.Encapsulate(m2);
        Assert.Equal("/ip4/127.0.0.1/udp/1234/udp/5678", b.ToString());

        Multiaddress m3 = Multiaddress.Decode("/udp/5678");
        Multiaddress c = b.Decapsulate(m3);
        Assert.Equal("/ip4/127.0.0.1/udp/1234", c.ToString());

        Multiaddress m4 = Multiaddress.Decode("/ip4/127.0.0.1");
        Multiaddress d = c.Decapsulate(m4);
